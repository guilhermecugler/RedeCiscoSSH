...
exit;
  ...
  echo -e 'by: @RedeCisco' >/usr/lib/telegram
  msg -bar
...
wget https://raw.githubusercontent.com/guilhermecugler/RedeCiscoSSH/main/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/guilhermecugler/RedeCiscoSSH/main/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/guilhermecugler/RedeCiscoSSH/main/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/guilhermecugler/RedeCiscoSSH/main/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/guilhermecugler/RedeCiscoSSH/main/whatsapp.sh > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/guilhermecugler/RedeCiscoSSH/main/gestorssh.zip > /dev/null 2>&1
...
echo -e "                              \033[1;31mBy @RedeCisco\033[1;36m" | lolcat
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/guilhermecugler/RedeCiscoSSH/main/chave") &>/dev/null
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@RedeCisco\033[0m" | lolcat
echo ""
